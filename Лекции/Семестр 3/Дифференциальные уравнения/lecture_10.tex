...
\begin{theorem}
    ...
    \end{equation}
    Где \(\lambda_1, \dots \lambda_m\) --- попарно различные собственные числа \(A\), где \(P_j(t) = (P_{j1}(t), P_{j2}(t), \dots P_{jn}(t)), \deg P_{jk} \le \) размера соответствующей Жордановой клетки.
\end{theorem}
\begin{proof}
